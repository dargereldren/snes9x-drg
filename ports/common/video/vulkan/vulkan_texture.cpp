...
void Texture::from_buffer(vk::CommandBuffer cmd, uint8_t *buffer, int width, int height, int byte_stride) {
	...
	image_layout_transition(cmd, image, vk::ImageLayout::eUndefined, vk::ImageLayout::eTransferDstOptimal, range(0));
