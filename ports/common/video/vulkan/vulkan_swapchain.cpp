...
bool Swapchain::create() {
	...
	extents.width = std::clamp(extents.width, surface_capabilities.minImageExtent.width, surface_capabilities.maxImageExtent.width);
	extents.height = std::clamp(extents.height, surface_capabilities.minImageExtent.height, surface_capabilities.maxImageExtent.height);
