...
bool loadPngImage(const char *name, int &outWidth, int &outHeight, bool &grayscale, bool &outHasAlpha, GLubyte **outData) {
#ifdef HAVE_LIBPNG
	png_structp png_ptr;
	png_infop info_ptr;
	...
	png_read_png(png_ptr, info_ptr, PNG_TRANSFORM_STRIP_16 | PNG_TRANSFORM_PACKING | PNG_TRANSFORM_EXPAND, (png_voidp) nullptr);
