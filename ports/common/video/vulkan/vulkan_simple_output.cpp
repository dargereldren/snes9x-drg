...
void SimpleOutput::create_objects() {
	...
	vk::DescriptorPoolCreateInfo dpci(vk::DescriptorPoolCreateFlagBits::eFreeDescriptorSet, 20, descriptor_pool_size);
...
void SimpleOutput::create_pipeline() {
	...
	blend_attachment_info
		.setColorWriteMask(vk::ColorComponentFlagBits::eB | vk::ColorComponentFlagBits::eG | vk::ColorComponentFlagBits::eR | vk::ColorComponentFlagBits::eA)
		.setBlendEnable(true)
