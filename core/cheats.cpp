...
#define _S9XCHTC(c, a, b)                                                           \
	((c) == S9X_LESS_THAN ? (a) < (b) : (c) == S9X_GREATER_THAN		   ? (a) > (b)  \
...
#define _S9XCHTD(s, m, o)                                                                                                                             \
	((s) == S9X_8_BITS ? ((uint8)(*((m) + (o)))) : (s) == S9X_16_BITS ? ((uint16)(*((m) + (o)) + (*((m) + (o) + 1) << 8)))                            \
											   : (s) == S9X_24_BITS	  ? ((uint32)(*((m) + (o)) + (*((m) + (o) + 1) << 8) + (*((m) + (o) + 2) << 16))) \
																	  : ((uint32)(*((m) + (o)) + (*((m) + (o) + 1) << 8) + (*((m) + (o) + 2) << 16) + (*((m) + (o) + 3) << 24))))

#define _S9XCHTDS(s, m, o)                                                                                                                                        \
	((s) == S9X_8_BITS ? ((int8)(*((m) + (o)))) : (s) == S9X_16_BITS ? ((int16)(*((m) + (o)) + (*((m) + (o) + 1) << 8)))                                          \
